...
ENV GITLAB_VERSION="13.2.2-ee" \
    GITLAB_SHELL_VERSION="13.3.0" \
    GITLAB_WORKHORSE_VERSION="8.37.0" \
    GITLAB_PAGES_VERSION="1.21.0" \
    GITALY_SERVER_VERSION="13.2.2" \
    GITLAB_ELASTICSEARCH_INDEXER_VERSION="2.4.0" \
    GITLAB_USER="git" \
