...
[![Build Status](https://img.shields.io/github/actions/workflow/status/tiredofit/docker-gitlab-ee/main.yml?branch=main&style=flat-square)](https://github.com/tiredofit/docker-gitlab-ee/actions)
...
You can use a password by passing --env 'REDIS_PASS=password'.
...
| `REDIS_PASS` | Optional Redis Authentication |
...
| `LDAP_GROUP_BASE` | Base DN for Searching Groups |
| `LDAP_ADMIN_GROUPS` | List of LDAP Group names that will give Admin access to Gitlab |
| `LDAP_EXTERNAL_GROUPS` | List of LDAP Group names that will give "External" access to Gitlab |
| `LDAP_SYNC_SSH_KEYS | Attribute for syncing SSH keys. Default `false`
